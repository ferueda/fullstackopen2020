...
describe('total likes', () => {
  ...
  test('when list has only one blog, should equal the likes of that one blog', () => {
    const blogs = [
      {
        title: 'test blog',
        author: 'Felipe Rueda',
  ...
  test('of a bigger list is calculated right', () => {
    expect(listHelper.totalLikes(blogs)).toBe(
...
describe('most liked', () => {
  ...
  test('when list has only one blog, should show that blog', () => {
    const blogs = [
      {
        title: 'test blog',
        author: 'Felipe Rueda',
...
//   test('one blog array should return that author', () => {
//     const blogs = [
//       {
//         _id: '5a422b3a1b54a676234d17f9',
//         title: 'Canonical string reduction',
